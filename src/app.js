...
import koaApp from './app/index.js'

const cpuNums = os.cpus().length
const certBase = path.join(path.resolve(), ".\\public\\ssl\\7681157_azhmau.top_other")

koaApp.use(koaStatic(path.join(path.resolve(),'.\\public\\static')))
